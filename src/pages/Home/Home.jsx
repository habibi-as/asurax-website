...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="home-root">
      {/* ASURAX: LiquidEther Background - layered behind interstellar */}
      <div className="liquid-ether-bg">
        <LiquidEther
          colors={['#5227FF', '#FF9FFC', '#B19EEF', '#4BD7FF']}
          resolution={0.5}
          mouseForce={20}
          cursorSize={100}
          autoDemo={true}
      ...
      {/* Gradient Background */}
      <div 
        className="interstellar-bg"
        style={{ 
          background: 'radial-gradient(circle at center, #0a0a14, #050508 70%)',
          position: 'fixed',
          inset: 0,
          zIndex: -20,
          pointerEvents: 'none'
      ...
      <main className="home-content">
        ...
        <section className="hero-section hero-large">
          <div className="hero-inner">
            {/* ASURAX: Logo with metallic effect - centered - Optimized */}
            <motion.div
            ...
            >
              <div className="metallic-canvas">
                {imageData ? (
                  <MetallicPaint
                    imageData={imageData}
                    params={{ edge: 2, patternBlur: 0.005, patternScale: 2, refraction: 0.015, speed: 0.2, liquid: 0.05 }}
                  />
                ) : (
                  <img 
                    src={logoFile} 
                    ...
                    loading="lazy"
                    style={{ width: '100%', height: '100%', objectFit: 'contain', filter: 'drop-shadow(0 18px 48px rgba(43, 12, 78, 0.45))' }}
                  />
                )}
              </div>
              <div className="logo-glow" />
              <div className="logo-rim-light" />
              {/* ASURAX: Center logo inside oval */}
              <img 
                src={logoFile}
                alt="ASURAX Logo"
