  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: '40px 20px',
        background: `
          linear-gradient(135deg, rgba(234, 221, 200, 0.1) 0%, rgba(139, 94, 60, 0.05) 50%, rgba(10, 10, 16, 0.95) 100%),
          repeating-linear-gradient(
            0deg,
            transparent,
            transparent 2px,
            rgba(139, 94, 60, 0.05) 2px,
      ...
      >
        <motion.h1
          ...
          style={{
            ...
            textShadow: '2px 2px 4px rgba(0, 0, 0, 0.7), 0 0 20px rgba(196, 164, 106, 0.5)',
            marginBottom: '20px',
            letterSpacing: '2px'
          }}
        >
        ...
        <motion.button
          ...
          style={{
            ...
            color: '#1a0f0a',
            background: `
              linear-gradient(135deg, #C4A46A 0%, #A67C52 100%)
            `,
            border: '2px solid rgba(196, 164, 106, 0.8)',
            borderRadius: '8px',
            cursor: 'pointer',
            fontFamily: 'Georgia, serif',
